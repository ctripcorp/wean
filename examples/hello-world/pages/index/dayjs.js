      ...
      l = {
        ...
        m: function t2(e2, n2) {
          ...
          var r2 = 12 * (n2.year() - e2.year()) + (n2.month() - e2.month()),
            i2 = e2.clone().add(r2, u),
            s2 = n2 - i2 < 0,
            a2 = e2.clone().add(r2 + (s2 ? -1 : 1), u)
        ...
        return (
          ...
          ($2.startOf = function (t2, a2) {
            var h2 = this,
              ...
              $3 = function (t3, e2) {
                var n2 = g.w(
                  h2.$u ? Date.UTC(h2.$y, e2, t3) : new Date(h2.$y, e2, t3),
                  h2
                )
              ...
              l2 = function (t3, e2) {
                return g.w(
                  h2
                    ...
                    [t3].apply(
                      h2.toDate('s'),
                      (c2 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e2)
                    ),
                  h2
                )
              },
          ...
          ($2.$set = function (s2, a2) {
            var h2,
              ...
              (h2[n] = d3 + 'Minutes'),
              (h2[e] = d3 + 'Seconds'),
              (h2[t] = d3 + 'Milliseconds'),
              h2)[c2],
              l2 = c2 === i ? this.$D + (a2 - this.$W) : a2
            if (c2 === u || c2 === o) {
              var y2 = this.clone().set(f, 1)
              y2.$d[$3](l2),
                y2.init(),
                (this.$d = y2.set(f, Math.min(this.$D, y2.daysInMonth())).$d)
            } else $3 && this.$d[$3](l2)
          ...
          ($2.add = function (t2, a2) {
            ...
            if (c2 === s) return d3(7)
            var $3 =
                ((f2 = {}), (f2[n] = 6e4), (f2[r] = 36e5), (f2[e] = 1e3), f2)[
                  c2
                ] || 1,
              l2 = this.$d.getTime() + t2 * $3
            return g.w(l2, this)
          }),
          ...
          ($2.format = function (t2) {
            ...
            var n2 = t2 || 'YYYY-MM-DDTHH:mm:ssZ',
              r2 = g.z(this),
              i2 = this.$locale(),
              s2 = this.$H,
              u2 = this.$m,
          ...
          ($2.diff = function (t2, f2, h2) {
            var c2,
              d3 = g.p(f2),
              $3 = v(t2),
              l2 = 6e4 * ($3.utcOffset() - this.utcOffset()),
              y2 = this - $3,
              M2 = g.m(this, $3)
            return (
              (M2 =
