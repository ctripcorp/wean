;(function (global, factory) {
  ...
  const isChanged = (a, b) => {
    return (
      !a || a.length !== b.length || b.some((arg, index) => arg !== a[index])
    )
  }
  ...
  const shouldYield = () => {
    ...
    return (
      ((_b =
        (_a = navigator) === null || _a === void 0 ? void 0 : _a.scheduling) ===
        null || _b === void 0
        ? void 0
        : _b.isInputPending()) || getTime() >= deadline
    )
  }
  ...
  const reconcileChildren = (WIP, children) => {
    ...
    let aCh = WIP.kids || [],
      ...
      map = null,
      ch = Array(bCh.length),
      next = ((_a = WIP.sibling) === null || _a === void 0 ? void 0 : _a.node)
        ? WIP.sibling
        : null
  ...
  const commit = (fiber) => {
    ...
    if (lane & 4) {
      parentNode.insertBefore(
        fiber.node,
        (_a = fiber.after) === null || _a === void 0 ? void 0 : _a.node
      )
    }
    fiber.lane = 0
    refer(ref, node)
